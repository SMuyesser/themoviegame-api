...
app.get('/moviedetails/:movieId', (req, res) => {
	axios.get('https://api.themoviedb.org/3/movie/'+req.params.movieId+'/credits?api_key='+TMDB_API_KEY)
	.then(castinfo => {
...
app.get('/castmembermovies/:castMemberId', (req, res) => {
	axios.get('https://api.themoviedb.org/3/person/'+req.params.castMemberId+'/movie_credits?api_key='+TMDB_API_KEY)
	.then(movies => {
